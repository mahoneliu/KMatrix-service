...
-- 执行完成后验证SQL
-- =====================================
-- SELECT COUNT(*) AS node_count FROM km_node_definition;
-- SELECT COUNT(*) AS rule_count FROM km_node_connection_rule;
-- SELECT node_type, node_label, category FROM km_node_definition ORDER BY category;
