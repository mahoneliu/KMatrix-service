...
import org.dromara.ai.knowledge.domain.bo.BatchEmbeddingRequest;
import org.dromara.ai.knowledge.domain.bo.BatchGenerateQuestionsRequest;
import org.dromara.ai.knowledge.domain.bo.ChunkPreviewBo;
import org.dromara.ai.knowledge.domain.bo.ChunkSubmitBo;
import org.dromara.ai.knowledge.domain.bo.KmDocumentBo;
...
public class KmDocumentController extends BaseController {
    ...
    public R<List<KmDocumentVo>> batchCreateWebLink(
            @Validated @RequestBody org.dromara.ai.knowledge.domain.bo.BatchWebLinkBo bo) {
